...
class InsertRepository implements InsertRepositoryInterface
{
    ...
    public function insertForm($data){
      ...
      $questionair->reason71 = array_get($data,'reason71');
      $questionair->reason72 = array_get($data,'reason72');
      $questionair->reason73 = array_get($data,'reason73');
      $questionair->reason74 = array_get($data,'reason74');
      $questionair->reason75 = array_get($data,'reason75');
      $questionair->reason76 = array_get($data,'reason76');
      $questionair->reason76add = array_get($data,'reason76add');
      $questionair->reason8 = array_get($data,'reason8');
      $questionair->reason8add = array_get($data,'reason8add');
